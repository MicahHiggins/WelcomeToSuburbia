...
@onready var correct: AudioStreamPlayer = $"../../Sounds/correct"
@onready var incorrect: AudioStreamPlayer = $"../../Sounds/incorrect"
@onready var cabinet_move: AudioStreamPlayer = $"../../Sounds/cabinetMove"
